...
function show_comment1(){
	$('.comment_tropoi').text("This is a particularly disastrous and wasteful method. During trawling, the sea bottom is dredged and a great number of organisms get crushed to death or accidently caught in the nets. Small or noncommercial fish discarded into the sea injured or dead. Bottom trawlers dispose 30-70% (by weight) of their catches back to the sea.");
...
function show_comment2(){
	$('.comment_tropoi').fadeIn('fast');
	$('.comment_tropoi').text("Nets are often placed around from objects floating on the sea or special tools that help to aggregate fish (FAD), therefore they attract different species, such as tuna, sharks, turtles and marine mammals that come looking for food and shelter. With this method, undesirable catches of noncommercial species and juveniles is significantly caught.")
...
function show_comment3(){
	$('.comment_tropoi').text('A lot of endangered species such as sharks, turtles, sea mammals and birds get caught. Undesired catches may be decreased by using methods such as circular hooks or placing them deeper.');
	$('.comment_tropoi').fadeIn('fast');
	$('.mixano').css('filter', 'grayscale(100%)');
	$('.grigri').css('filter', 'grayscale(100%)');
...
function show_comment4(){
	$('.comment_tropoi').text('Coastal trawling method consisting of a trawl bag pulled by a winch from a boat that is tied to the coast. This method is particularly dangerous to seagrasses (e.g.)Posidonia oceanica) meadows, a sensitive and protected sea ecosystem. Furthermore, this method has a lot of undesired by-catches that discarded back to the sea');
	$('.comment_tropoi').fadeIn('fast');
	$('.mixano').css('filter', 'grayscale(100%)');
	$('.grigri').css('filter', 'grayscale(100%)');
	$('.pelagika').css('filter', 'grayscale(100%)');
